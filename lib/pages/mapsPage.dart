...
class _HomePageState extends State<HomePage> {
      ...
      body: Stack(
          children: [
            GoogleMap(
              ...
              onTap:(LatLng latLng) {
                print("Position clicked: "+latLng.toString());
                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                SizedBox(height: 15,),
                                Text("Vous souhaiter publier une chambre ou appartement disponible à cette adresse (position) ?", textAlign: TextAlign.center,style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 18),),
                                SizedBox(height: 8,),
                                MaterialButton(
                                  onPressed: () {},
                                  elevation: 0,
                                  ...
                                  child: Text("Oui",textAlign: TextAlign.center, style: TextStyle(fontSize: 14,color: Color.fromARGB(255, 255, 255, 255)),),
                                ),
                                SizedBox(height: 5,),
                                MaterialButton(
                                  onPressed: () {
                                  ...
                                  child: Text("Annuler",textAlign: TextAlign.center, style: TextStyle(fontSize: 14,color: Color.fromARGB(255, 255, 255, 255)),),
                                ),
              ...
              onLongPress: (LatLng latLng) {
                              ...
                              children: [
                                Container(
                                  ...
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10.0),
                                    child: Image.network(
                                      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXMgRJSHkbKvktWAxU96Z56RQ5TXjmb5r03A&usqp=CAU',
                                ...
                                MaterialButton(
                                  ...
                                  child: Text("Voir les détails", style: TextStyle(color: Colors.black),),
                                )
                              ],
                            ),
                          ),
                ...
                setState(() {
                  ...
                  print("LatLng from 'setState': $latLng.toString()");
                });
              },
              ...
              //----------- Intégration de la position courante du 'User' lors de la chargement de la Carte
              onMapCreated: (GoogleMapController controller) async  {
                Position position = await _determinePosition();
                LatLng latlongCurrentPos;
                _controller = controller;
                _customInfoWindowController.googleMapController = controller;
                _controller!.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(target: LatLng(position.latitude, position.longitude), zoom: 14)));

                _markers.clear();

                latlongCurrentPos = LatLng(position.latitude, position.longitude);

                Marker marker_ = Marker(                
                  markerId: const MarkerId('currentLocation'),
                  position: LatLng(position.latitude, position.longitude),
                  icon: await _getAssetIcon(context, 'assets/markers/marker-5.png').then((value) => value),
                  onTap: () {
                    _customInfoWindowController.addInfoWindow!(
                      Stack(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(15.0),
                              color: Color.fromARGB(255, 3, 28, 41),
                            ),
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              crossAxisAlignment: CrossAxisAlignment.center,
                ...
                setState(() {
                   _markers[latlongCurrentPos.toString()] = marker_;
                });
                // setState(() {});
              } //------------------------------------------------------------------------------------
                        ...
                        showModalBottomSheet(
                          ...
                          builder: (context) => Container(
                            ...
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text("Choisir un thème", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 18),),
                                SizedBox(height: 20,),
                                Container(
                                  width: double.infinity,
                                  height: 100,
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Center(
                  child:
                    Image.asset("assets/images/alafunty.png", fit: BoxFit.cover, width:125, height: 50),
                )
              ),
            ),
            Positioned(
  ...
  // pour avoir la position du device par extension du User
  ...
  // --------for getting custom icon for GOOLE MAPS markers for user current location 
